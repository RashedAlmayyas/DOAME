...
function MyApp() {
  ...
  <a href="contact" class="-mb-px border-b border-transparent p-4 text-cyan-500">
    contact us
  </a>

  <a href="regster" class="-mb-px border-b border-transparent p-4 hover:text-cyan-500">
  register
  </a>
</nav>
